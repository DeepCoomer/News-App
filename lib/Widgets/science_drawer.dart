...
class ScienceDrawer extends StatefulWidget {
  const ScienceDrawer({Key? key}) : super(key: key);

  @override
  _ScienceDrawerState createState() => _ScienceDrawerState();
}

class _ScienceDrawerState extends State<ScienceDrawer> {
  @override
