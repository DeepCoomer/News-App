...
import 'package:mynewsapp/Widgets/science_drawer.dart';
...
class _ScienceNewsState extends State<ScienceNews> {
  ...
  Future<List<Articles>?> fetchNews() async {
    var url =
        "https://newsapi.org/v2/top-headlines?country=us&category=science&apiKey=d65ec3df76b0482bade20e7c2b295d08";
